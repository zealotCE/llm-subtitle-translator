...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "nav.advanced": "高级",
    "nav.language": "语言",
    "nav.workerStatus": "Worker",
    "nav.workerOnline": "在线",
    "nav.workerOffline": "离线",
    "nav.workerUnknown": "未知",
    "common.loading": "加载中…",
    "common.search": "搜索",
    "common.save": "保存",
    "common.saved": "已保存",
    ...
    "library.empty": "暂无媒体",
    "activity.title": "任务中心",
    "activity.subtitle": "以工单流转形式追踪扫描、识别与翻译进度。",
    "activity.type": "类型",
    "activity.status": "状态",
    ...
    "activity.stage.segment": "切片",
    "activity.stage.srt": "产出",
    "activity.stage.done": "完成",
    "activity.card.media": "媒体",
    "activity.card.task": "任务",
    "activity.card.created": "创建时间",
    "activity.card.progress": "当前进度",
    "activity.card.flow": "流转进度",
    "activity.card.tip": "点击查看媒体或运行详情。",
    "activity.filter.title": "过滤",
    "activity.filter.type": "任务类型",
    "activity.filter.status": "任务状态",
    "activity.filter.page": "分页",
    "activity.emptyHint": "你可以从媒体库触发 ASR/翻译任务，或等待自动扫描。",
    ...
    "activity.type.run_progress": "运行进度",
    ...
    "activity.msg.run_progress": "运行进度更新",
    "activity.systemLogs": "系统日志",
    "logs.title": "系统日志",
    "logs.source": "来源",
    "logs.source.all": "全部",
    "logs.source.web": "Web",
    "logs.source.worker": "Worker",
    "logs.source.unknown": "其他",
    "logs.sourceHint": "支持按日志来源筛选，优先读取结构化字段。",
    "logs.keyword": "关键词",
    "logs.limit": "条数",
  ...
  en: {
    ...
    "nav.workerStatus": "Worker",
    "nav.workerOnline": "Online",
    "nav.workerOffline": "Offline",
    "nav.workerUnknown": "Unknown",
    ...
    "dashboard.viewActivity": "View Tasks",
    ...
    "activity.subtitle": "Track scanning, ASR, and translation flows like work orders.",
    "activity.type": "Type",
    ...
    "activity.stage.segment": "Segmentation",
    "activity.stage.srt": "SRT Output",
    "activity.stage.done": "Done",
    "activity.card.media": "Media",
    "activity.card.task": "Task",
    "activity.card.created": "Created",
    "activity.card.progress": "Progress",
    "activity.card.flow": "Flow",
    "activity.card.tip": "Open media or run details.",
    "activity.filter.title": "Filters",
    "activity.filter.type": "Task Type",
    "activity.filter.status": "Task Status",
    "activity.filter.page": "Pagination",
    "activity.emptyHint": "Trigger ASR/translation from library or wait for watcher scans.",
    ...
    "activity.type.run_progress": "Run Progress",
    ...
    "activity.msg.run_progress": "Run progress updated",
    ...
    "logs.source.web": "Web",
    "logs.source.worker": "Worker",
    "logs.source.unknown": "Other",
    "logs.sourceHint": "Filters use structured fields when available.",
